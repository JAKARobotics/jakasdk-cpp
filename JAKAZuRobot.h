...
///@{
	...
	*
	* @param vel_cfg Parameters for velocity compliance control.
	*
	* @return Indicate the status of operation. ERR_SUCC for success and other for failure.
	*/
...
///@{
	...
	*/
	...
	/**
	* @brief Download a file of the specified type and name from the controller.
	*
	...
	*/
	...
	/**
	* @brief Upload a file of a specified type to the controller.
	*
